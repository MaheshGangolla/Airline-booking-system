...
<br>
        ...
        <div class="container-xxl py-5">
            <div class="container">
                <div class="text-center wow fadeInUp" data-wow-delay="0.1s">
                    <h6 class="section-title text-center text-primary text-uppercase">Update Flight Details in DataBase</h6>
                    <h1 class="mb-5">Modify  <span class="text-primary text-uppercase">Existing Flight</span></h1>
                </div>
                <div class="row g-5">
                        <div class="wow fadeInUp" data-wow-delay="0.2s">
                            <form method="post" action="update_flight_validation.jsp" onsubmit="return validateForm()">
                                <div class="row g-3">
                                    <div class="col-md-6">
                                       <div class="form-floating">
    <label>Enter Flight ID</label>
  <input type="text" class="form-control" placeholder="Enter Flight Id" name="flight_Id" value="<%= (request.getParameter("flightId") != null) ? request.getParameter("flightId") : "" %>">
</div>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" name="flight_name" id="flight_name"  >
                                                <option selected><%= (request.getParameter("flightName") != null) ? request.getParameter("flightName") : "Enter Flight Name" %></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" name="from_city" id="from_city"  >
                                                <option selected><%= (request.getParameter("fromCity") != null) ? request.getParameter("fromCity") : "Update Departure City Name" %></option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                            <select class="form-select" name="to_city"  id="to_city" >
                                                ...
                                                <option selected><%= (request.getParameter("toCity") != null) ? request.getParameter("toCity") : "Update Arrival City Name" %></option>
                                                <option value="Ahmedabad Airport - AMD">Ahmedabad Airport - AMD</option>
                                                <option value="Amritsar Airport - LUH">Amritsar Airport - LUH</option>
                                                <option value="Bagdogra Airport - IXB">Bagdogra Airport - IXB</option>
                                                <option value="Bengaluru International Airport - BLR">Bengaluru International Airport - BLR</option>
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                         <label for="checkin">Update Date Of Flight</label>
                                           <input type="date" class="form-control" placeholder="Date Of Flight" name="date_of_flight" value="<%= request.getParameter("date") != null ? request.getParameter("date") : "" %>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                           <label>Update Departure Time</label>
                                            <input type="text" class="form-control" placeholder="Enter Flight Departure Time HH:MM:SS" name="flight_arrival_time" value="<%= request.getParameter("arrivalTime") != null ? request.getParameter("arrivalTime") : "" %>">
                                         
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                                     <label>Update Arrival Time</label>
                                            <input type="text" class="form-control" placeholder="Enter Flight Arrival Time HH:MM:SS" id="frt" name="flight_reach_time" value="<%= request.getParameter("reachTime") != null ? request.getParameter("reachTime") : "" %>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                                     <label>Update First Class Seat</label>
                                        <input type="text" class="form-control" placeholder="Enter First Class Seat" name="first_class_seat" value="<%= request.getParameter("firstClassSeat") != null ? request.getParameter("firstClassSeat") : "" %>">
                               
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                                          <label>Update First Class Seat Price</label>
                                                <input type="text" class="form-control" placeholder="Enter First Class Seat Price" name="first_class_price" value="<%= request.getParameter("firstClassPrice") != null ? request.getParameter("firstClassPrice") : "" %>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                               <label>Update Business Class Seat</label>
                                      <input type="text" class="form-control" placeholder="Enter Business Class Seat" name="buss_class_seat" value="<%= request.getParameter("businessClassSeat") != null ? request.getParameter("businessClassSeat") : "" %>">
                       
                                        </div>
                                    </div>
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                                 <label>Update Business Class Seat Price</label>
                                      <input type="text" class="form-control" placeholder="Enter Business Class Seat Price" name="buss_class_price" value="<%= request.getParameter("businessClassPrice") != null ? request.getParameter("businessClassPrice") : "" %>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                             ...
                                             <label>Update Economy Class Seat</label>
                                             
                                    <input type="text" class="form-control" placeholder="Enter Economy Class Seat" name="eco_class_seat" value="<%= request.getParameter("economyClassSeat") != null ? request.getParameter("economyClassSeat") : "" %>">
                                    ...
                                    <div class="col-md-6">
                                        <div class="form-floating">
                                                 <label>Update Economy Class Seat Price</label>
                                       <input type="text" class="form-control" placeholder="Enter Economy Class Seat Price" name="eco_class_price" value="<%= request.getParameter("economyClassPrice") != null ? request.getParameter("economyClassPrice") : "" %>">
                                   
                                        </div>
                                    </div>
                                    
                                    <div class="search-container">
                                        <button class="btn btn-primary w-100 py-3" type="submit"><b>Update Flight</button>
                                    </div>
 ...
 function validateForm() {
     const flightId = document.getElementById("flight_id").value.trim();
     ...
     if (flightName === "Enter Flight Name" || fromCity === "Update Departure City Name" || toCity === "Update Arrival City Name" || !dateOfFlight) {
