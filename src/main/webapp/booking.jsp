...
<head>
  ...
  function booking_validate() {
            ...
            if (username === "") {
                ...
                alert("Number of passengers should be 1!");
                return false;
            } else if (adults !== "0" && adults !== "1") {
                alert("Total number of adults should be 0 or 1!");
                return false;
                ...
                <div class="col-md-6">
                 ...
                 <div class="col-md-6">
                    <div class="form-floating">
                        ...
                        <input type="number" id="noOfPassengers" name="noOfPassengers" value=1 required readonly>
                    </div>
                </div>
               <div class="col-md-6">
                    <div class="form-floating">
                        <label for="adults">Select Number Of Adults</label>
                        <input type="number" class="form-control" id="adults" placeholder="Total Number Of Adults" name="adults" min="0" max="1" required>
                    </div>
                </div>
                <div class="col-md-6">
                    <div class="form-floating">
